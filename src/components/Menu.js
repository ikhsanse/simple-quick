...
const Menu = (props) => {
  return (
    <>
      <div className="flex h-auto item-stretch py-8">
        <div
          className={`flex self-center h-auto shrink-0  ${
            props.taskShow ? "order-last" : "order-first"
          }`}
        >
          <div
            className={`${
              props.openMenu
                ...
                : "translate-x-[11rem] ease-in duration-300"
            } w-full h-full text-center self-center ml-[26px] `}
          >
            <p
              className={`${props.openMenu ? "opacity-1" : "opacity-0"} ${
                props.taskShow ? "opacity-0 z-[-10]" : "opacity-1"
              } gray-six font-bold mb-[13px] font-lato ease-in duration-300`}
            >
              Task
            </p>
            <div className="relative">
              <div
                className={`absolute inset-0 ${
                  props.taskShow
                    ? "w-[68px] h-[68px] -translate-x-4"
                    : "w-[60px] h-[60px] translate-x-0"
                }  bg-home-input rounded-full z-9 ease-in duration-300`}
              ></div>
              <button
                className={`${
                  props.taskShow
                    ? "bg-task-true w-[68px] h-[68px] "
                    : "bg-menu-false  w-[60px] h-[60px]"
                } relative rounded-full z-10 ease-in duration-300`}
                onClick={props.menuTaskHandler}
              >
                <svg
        ...
        <div className="flex self-center h-auto w-full">
          <div
            className={`${
              props.openMenu ? "translate-x-0" : "translate-x-[5.5rem]"
            }  text-center h-inherit self-center ml-[26px] ease-in duration-300`}
          >
            <p
              className={`${props.openMenu ? "opacity-1" : "opacity-0"} ${
                props.inboxShow ? "opacity-0 z-[-10]" : "opacity-1"
              } gray-six font-bold mb-[13px] font-lato ease-in duration-300`}
            >
              Inbox
            </p>
            <div className="relative">
              ...
              <button
                className={`${
                  props.inboxShow
                    ? "bg-inbox-true  w-[68px] h-[68px]"
                    : "bg-menu-false w-[60px] h-[60px]"
                } relative z-10 rounded-full ease-in duration-300`}
                onClick={props.menuInboxHandler}
              >
                <svg
                  className="mx-auto w-[24px] h-[18px]"
                  width="26"
        ...
        <div
          className={`w-full h-inherit mt-8 self-center ml-[26px] z-[9999] ${props.showHideBolt}`}
        >
          <button
            className="w-[68px] bg-bolt h-[68px] rounded-full"
            onClick={props.menuBoltHandler}
          >
